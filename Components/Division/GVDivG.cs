...
<<<<<<< TODO: Unmerged change from project 'VoussoirPlugin03 (net7.0)', Before:
                Surface loftSrf = Components.PolylineUtils.AlignNormalToWorldZ(loftBrep.Surfaces[0]);
=======
                Surface loftSrf = PolylineUtils.AlignNormalToWorldZ(loftBrep.Surfaces[0]);
>>>>>>> After
                Surface loftSrf = VoussoirPlugin03.Components.BaseSurface.PolylineUtils.AlignNormalToWorldZ(loftBrep.Surfaces[0]);
